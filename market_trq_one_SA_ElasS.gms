...
scalar min_elasSup /.2/;

scalar max_elasSup "max value of supply elasticity" /1.5/;
...
* Hessian calculated with normalized prod. price (constant term is set in calibration.gms)
  p_hessNQSupp("R1",XX,XX,"CUR") = p_elasSup("R1",XX,XX) * DATA("R1","prod",XX,"Cur")
                                / (DATA("R1","PPRi",XX,"CuR")/DATA("R1","ppri","Inpe","Cur"));
...
execute_unload "SA_results_elasSup_R1Importer.gdx", p_results_tot, p_trade_diversion_tot, p_trade_diversion_relative_tot,
                                      p_trade_diversion_bilat_tot, p_trade_creation_tot, p_trq_fillrate_tot, p_Supply_elas_tot;